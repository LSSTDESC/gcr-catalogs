...
- `cosmoDC2_v1.1.4_wazp_v1.0`: WaZP catalog (v1.0) for `cosmoDC2_v1.1.4` using true redshifts (provided by Michel Aguena).
...
- `cosmoDC2_v1.1.4_image_with_photozs_flexzboost_v1_wazp_v1.0`: WaZP catalog (v1.0) for `cosmoDC2_v1.1.4_image_with_photozs_flexzboost_v1` using FlexZBoost redshifts (provided by Michel Aguena).
