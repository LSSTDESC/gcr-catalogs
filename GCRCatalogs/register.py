...
class ConfigManager(Mapping):
    ...
    def resolve_reference(self, config_dict, config_name=None, past_refs=None):
        """
        This function is a "resolver" function that is used to resolve config
        files.
    ...
    def default_catalog_configs(self):
        return self.get_configs(resolve_content=True, include_default_only=True,
                                include_pseudo=False)
...
def retrieve_paths(name_startswith=None, name_contains=None, **kwargs):
    ...
    """
    check_for_reg()
    return ConfigSource.config_source.retrieve_paths(name_startswith=name_startswith,
                                              name_contains=name_contains,
                                              **kwargs)
