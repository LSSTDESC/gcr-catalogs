...
u_control = catalog_qties['LSST_filters/diskLuminositiesStellar:LSST_u:rest:dustAtlas'][first_disk]
g_control = catalog_qties['LSST_filters/diskLuminositiesStellar:LSST_g:rest:dustAtlas'][first_disk]
r_control = catalog_qties['LSST_filters/diskLuminositiesStellar:LSST_r:rest:dustAtlas'][first_disk]
i_control = catalog_qties['LSST_filters/diskLuminositiesStellar:LSST_i:rest:dustAtlas'][first_disk]
z_control = catalog_qties['LSST_filters/diskLuminositiesStellar:LSST_z:rest:dustAtlas'][first_disk]
y_control = catalog_qties['LSST_filters/diskLuminositiesStellar:LSST_y:rest:dustAtlas'][first_disk]

u_dustless = catalog_qties['LSST_filters/diskLuminositiesStellar:LSST_u:rest'][first_disk]
g_dustless = catalog_qties['LSST_filters/diskLuminositiesStellar:LSST_g:rest'][first_disk]
r_dustless = catalog_qties['LSST_filters/diskLuminositiesStellar:LSST_r:rest'][first_disk]
i_dustless = catalog_qties['LSST_filters/diskLuminositiesStellar:LSST_i:rest'][first_disk]
z_dustless = catalog_qties['LSST_filters/diskLuminositiesStellar:LSST_z:rest'][first_disk]
y_dustless = catalog_qties['LSST_filters/diskLuminositiesStellar:LSST_y:rest'][first_disk]
...
dm_list = cosmo.distanceModulus(redshift_list)

fudge = 2.0*2.5*np.log10(1.0+redshift_list)

u_control = -2.5*np.log10(u_control)
g_control = -2.5*np.log10(g_control)
r_control = -2.5*np.log10(r_control)
i_control = -2.5*np.log10(i_control)
z_control = -2.5*np.log10(z_control)
y_control = -2.5*np.log10(y_control)

u_dustless = -2.5*np.log10(u_dustless)
g_dustless = -2.5*np.log10(g_dustless)
r_dustless = -2.5*np.log10(r_dustless)
i_dustless = -2.5*np.log10(i_dustless)
z_dustless = -2.5*np.log10(z_dustless)
y_dustless = -2.5*np.log10(y_dustless)
...
out_file = open('Rv_vs_magdist_rest.txt', 'w')
...
for i_star in range(len(sed_name_list)):
    ...
    mag_list = lsst_bp_dict.magListForSed(sed) - dm
    dustless_list = lsst_bp_dict.magListForSed(dustless) - dm
